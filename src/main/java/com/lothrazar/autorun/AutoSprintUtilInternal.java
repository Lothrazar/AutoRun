...
// only ever constructed/invoked from AutoSprintEvents, which AutoSprintMod registers
// only when FMLEnvironment.getDist() == Dist.CLIENT - structurally client-only
